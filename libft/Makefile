...
SRC = ft_abs.c ft_atoi.c ft_bzero.c ft_delimitcount.c ft_intlen.c ft_isalnum.c	\
	ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c ft_ispunct.c ft_isspace.c	\
	...
	ft_reverse_string.c ft_strcat.c ft_strchr.c ft_strclr.c				\
	...
	ft_strstr.c ft_strsub.c ft_strtrim.c ft_tolower.c ft_toupper.c ft_strjoinf.c ft_strdupf.c get_next_line.c
